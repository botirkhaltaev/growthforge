...
export const DEMO_VARIANTS: AdVariant[] = [
  {
    ...
    price: "$35",
    gradient: "linear-gradient(145deg, #0f766e 0%, #134e4a 45%, #042f2e 100%)",
    visualEmoji: "🧴",
    visualCaption: "Product shot · studio white",
    ctr: 1.2,
    cvr: 0.8,
    roas: 1.1,
  ...
  },
  {
    ...
    brand: "Sustainable Bottle Co.",
    price: "$35",
    gradient: "linear-gradient(145deg, #1e3a5f 0%, #0c4a6e 50%, #082f49 100%)",
    visualEmoji: "🌊",
    visualCaption: "Ocean plastic · impact metric",
    ctr: 2.8,
    cvr: 1.6,
    roas: 2.4,
  ...
  },
  {
    ...
    brand: "Sustainable Bottle Co.",
    price: "$35",
    gradient: "linear-gradient(145deg, #78350f 0%, #92400e 40%, #1c1917 100%)",
    visualEmoji: "☕",
    visualCaption: "Lifestyle · hiking with bottle",
    ctr: 4.1,
    cvr: 2.9,
    roas: 4.2,
