        ...
        <div className="rounded-3xl border border-white/[0.08] bg-surface/80 p-5 shadow-2xl shadow-black/30">
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="mt-2 flex gap-1.5 overflow-x-auto pb-1 scrollbar-none sm:flex-wrap sm:overflow-visible sm:pb-0">
                {scope.signals.map((signal) => (
                  <span
                    key={signal}
                    title={signal}
                    className="shrink-0 whitespace-nowrap rounded-full border border-amber/25 bg-amber/10 px-2.5 py-1 text-[10px] leading-snug text-amber-bright sm:whitespace-normal sm:text-[11px]"
                  >
                    {signal}
                  </span>
                ))}
